...
public class PeriodicTable : MonoBehaviour
{
    ...
    void SelectOption(Toggle toggle, bool on)
    {
        ...
        else
        {
            ...
            setMessage.SetNotice("Yuk, apakah kamu ingat nama mineral di tabel periodik?");
            setMessage.SetTextbox(SetMessage.textboxState.Normal);
    ...
    void CheckAnswer()
    {
        ...
        if (point == 2)
        {
            ...
            setMessage.SetNotice("Betul! lambang kimia tembaga dan emas adalah Cu (Cuprum) dan Au (Aurum)!");
        ...
        else
        {
            ...
            setMessage.SetNotice("Aduh, kurang tepat! Lambang kimia tembaga dan emas adalah Cu (Cuprum) dan Au (Aurum).");
